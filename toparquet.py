...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "blog", table_name = "tblastinput", transformation_ctx = "datasource0", additional_options = {"jobBookmarkKeys":["cnpj_empresa"]})
